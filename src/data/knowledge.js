...
const KNOWLEDGE_FOCUS = [
  ...
  { priority: 'high', pattern: /\b(hoodwise token|hood wise token|hoodwise contract|hoodwise address|hwi|0x6bdb637a9e988835dc368ef72cb5d143540f037c)\b/i, instruction: 'FOCUS: Answer directly that the Hoodwise project contract is 0x6bdb637a9e988835dc368ef72cb5d143540f037c and that the project owner supplied it as the Hoodwise launch contract on Virtuals.io. Lead with the project framing first: Hoodwise project contract, Virtuals.io launch context, Robinhood Chain address. Make clear this is Hoodwise project context, not an official Robinhood asset. If live onchain scan says source code is not verified or owner/liquidity fields are unavailable, phrase it calmly under What to verify next rather than opening with a red-flag tone. Do not call it suspicious solely because source verification or liquidity data is missing. Mention Blockscout exact address, source verification, holders, liquidity/pool, ownership controls, and current market conditions as normal verification checks.' },
