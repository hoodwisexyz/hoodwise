...
const counters = { chatRequests: 0, chatErrors: 0, streamFallbacks: 0, liveSearches: 0, verifierRequests: 0, verifierErrors: 0, landingViews: 0, appViews: 0, qualityReviews: 0, lowQualityReviews: 0, answerFeedback: 0 };
const timings = { chat: [] };
