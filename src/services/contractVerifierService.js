...
function tokenActivity(explorerAddress) { const token = explorerAddress?.token; return token ? { holders: token.holders_count ?? null, volume24h: token.volume_24h ?? null, exchangeRate: token.exchange_rate ?? null, circulatingMarketCap: token.circulating_market_cap ?? null } : null; }
