...
const CASES = [
  ...
  { id: 'official-check-id', prompt: 'kalau token namanya Robinhood berarti official ga?', needsSource: true, require: [/not\W{0,16}official|not a Robinhood|permissionless|anyone|siapa/i], forbid: [/\bis official by default\b/i, /official by default[^.]*because/i] },
